    ...
    <div className="w-full bg-canvas text-ink min-h-screen relative overflow-hidden flex flex-col items-center glow-orange">
      ...
      <section className="w-full max-w-3xl px-6 md:px-8 py-[96px] space-y-16 relative z-10 text-left">
        ...
        <div className="space-y-12">
          ...
          <div className="space-y-4">
            <h2 className="text-heading-4 text-ink">1. Information We Collect</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-heading-4 text-ink">2. How We Use Your Data</h2>
            <p className="text-body-md text-charcoal">We use the information we collect to:</p>
          ...
          <div className="space-y-4">
            <h2 className="text-heading-4 text-ink">3. API Query Data</h2>
            <p className="text-body-md text-charcoal">
            ...
            <div className="bg-cream border border-beige-deep rounded-lg p-6 space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-mono text-body">
                <div className="space-y-1">
                  <span className="text-slate text-[10px] uppercase tracking-wider font-bold">Layer 1</span>
                  <p className="text-ink">Redis in-memory cache (sub-10ms reads)</p>
                </div>
                <div className="space-y-1">
                  <span className="text-slate text-[10px] uppercase tracking-wider font-bold">Layer 2</span>
                  <p className="text-ink">PostgreSQL persistent cache (durable, queryable)</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h2 className="text-heading-4 text-ink">4. Data Sharing</h2>
            <p className="text-body-md text-charcoal">
          ...
          <div className="space-y-4">
            <h2 className="text-heading-4 text-ink">5. Data Security</h2>
            <p className="text-body-md text-charcoal">
          ...
          <div className="space-y-4">
            <h2 className="text-heading-4 text-ink">6. Data Retention</h2>
            <p className="text-body-md text-charcoal">
          ...
          <div className="space-y-4">
            <h2 className="text-heading-4 text-ink">7. Your Rights</h2>
            <p className="text-body-md text-charcoal">
          ...
          <div className="space-y-4">
            <h2 className="text-heading-4 text-ink">8. Cookies & Local Storage</h2>
            <p className="text-body-md text-charcoal">
          ...
          <div className="space-y-4">
            <h2 className="text-heading-4 text-ink">9. Changes to This Policy</h2>
            <p className="text-body-md text-charcoal">
