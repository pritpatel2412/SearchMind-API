...
export default function Terms() {
  return (
    <div className="w-full bg-canvas text-ink min-h-screen relative overflow-hidden flex flex-col items-center glow-orange">
      
      <section className="w-full max-w-3xl px-6 md:px-8 py-[96px] space-y-16 relative z-10 text-left">
        
        {/* Back link */}
        <Link to="/" className="inline-flex items-center gap-1.5 text-xs font-mono text-slate hover:text-ink transition-colors">
          <ArrowLeft size={12} />
          Back to Home
        </Link>
        ...
        <div className="space-y-12">
          ...
          <div className="space-y-4">
            <h2 className="text-heading-4 text-ink">1. Acceptance of Terms</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-heading-4 text-ink">2. Description of Service</h2>
            <p className="text-body-md text-charcoal">
          ...
          <div className="space-y-4">
            <h2 className="text-heading-4 text-ink">3. API Usage & Rate Limits</h2>
            <p className="text-body-md text-charcoal">
            ...
            <div className="bg-cream border border-beige-deep rounded-lg overflow-hidden">
              <table className="w-full text-left text-xs font-mono">
                <thead className="bg-cream border-b border-beige-deep">
                  <tr>
                    <th className="px-4 py-3 text-slate font-bold uppercase tracking-wider text-[10px]">Plan</th>
                    <th className="px-4 py-3 text-slate font-bold uppercase tracking-wider text-[10px]">Requests / Month</th>
                    <th className="px-4 py-3 text-slate font-bold uppercase tracking-wider text-[10px]">Rate Limit</th>
                  </tr>
                </thead>
          ...
          <div className="space-y-4">
            <h2 className="text-heading-4 text-ink">4. API Keys & Security</h2>
            <p className="text-body-md text-charcoal">
          ...
          <div className="space-y-4">
            <h2 className="text-heading-4 text-ink">5. Prohibited Uses</h2>
            <p className="text-body-md text-charcoal">You agree not to use the Service for:</p>
            <ul className="space-y-2 text-body-md text-charcoal pl-4">
          ...
          <div className="space-y-4">
            <h2 className="text-heading-4 text-ink">6. Data & Caching</h2>
            <p className="text-body-md text-charcoal">
          ...
          <div className="space-y-4">
            <h2 className="text-heading-4 text-ink">7. Service Level Agreement</h2>
            <p className="text-body-md text-charcoal">
          ...
          <div className="space-y-4">
            <h2 className="text-heading-4 text-ink">8. Modifications to Terms</h2>
            <p className="text-body-md text-charcoal">
          ...
          <div className="space-y-4">
            <h2 className="text-heading-4 text-ink">9. Limitation of Liability</h2>
            <p className="text-body-md text-charcoal">
